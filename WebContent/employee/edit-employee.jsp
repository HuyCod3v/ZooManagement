...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Cập Nhật Nhân Viên</h3>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form class="form-horizontal" action="/ZooManagement/do-edit-employee" method="post">
						<div class="form-group">
							...
							<div class="">
								<input type="text" class="form-control" id="employeeId"
									name="employeeId" readonly="readonly" placeholder="Mã Nhân Viên" value="${employee.employeeId}" >
							</div>
						</div>
						<div class="form-group">
