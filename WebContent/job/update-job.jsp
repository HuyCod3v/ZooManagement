...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">Cập nhật công việc</h3>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6">
					...
					<form class="form-horizontal" action='<c:url value="/job/do-update-job" />' method="post">
						<div class="form-group">
							...
							<div class="">
								<input type="text" class="form-control" id="jobId"
									name="jobId" placeholder="Mã Công Việc" readonly="readonly" required value="${job.jobId}">
							</div>
						</div>
						<div class="form-group">
